function sendEmails() {
  ...
  function fillInTemplateFromObject(template, data) {
    ...
    templateVars.forEach(varData => {
      // normalizeHeader ignores {{"}} so we can call it directly here.
      var variableData = data[normalizeHeader(varData)];
      email = email.replace(varData, variableData || varData + " not found");
    });
